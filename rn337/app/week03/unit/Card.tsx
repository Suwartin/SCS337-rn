    ...
    return (
        <View style={{ padding: 20 }}>
            ...
            <View style={{ flexDirection: "row", padding: 10 }}>
                <Image style={{ width: 50, height: 50, borderRadius: 50 / 2 }} source={require("@/assets/week03/profile-2.jpg")} />
            ...
            <View style={{ flexDirection: "row" }}>
                <Image style={{ flex: 1, resizeMode: "cover", aspectRatio: 4 / 2 }} source={require("@/assets/week03/trip-2.jpg")} />
            </View>
            {/* View ก้อนที่ 3 */}
